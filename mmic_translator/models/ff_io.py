...
__all__ = ["FFInToSchema", "FFInFromSchema", "FFOutToSchema", "FFOutFromSchema"]


class FFInToSchema(ProtoModel):
...
class FFOutToSchema(ProtoModel):
...
class FFOutFromSchema(ProtoModel):
